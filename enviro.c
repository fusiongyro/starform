...
double 
kothari_radius(double mass, int giant, int zone)
{
  double      temp,
              temp2,
              atomic_weight,
...
double 
volume_density(double mass, double equat_radius)
{
  double      volume;
...
double 
molecule_limit(double mass, double equat_radius)
{
  double      esc_velocity;
...
double 
vol_inventory(double mass, double escape_vel, double rms_vel, 
...
double 
boiling_point(double surf_pressure)
{
...
double 
hydro_fraction(double volatile_gas_inventory, double planet_radius)
{
  double      temp;
...
double 
cloud_fraction(double surf_temp, double smallest_MW_retained, double equat_radius, double hydro_fraction)
{
  double      water_vapor_in_kg,
              fraction,
              surf_area,
              hydro_mass;
...
double 
ice_fraction(double hydro_fraction, double surf_temp)
{
  double      temp;
...
double 
eff_temp(double ecosphere_radius, double orb_radius, double albedo)
{
...
double 
green_rise(double optical_depth, double effective_temp, double surf_pressure)
{
...
double 
planet_albedo(double water_fraction, double cloud_fraction, double ice_fraction, double surf_pressure)
{
...
double 
opacity(double molecular_weight, double surf_pressure)
{
